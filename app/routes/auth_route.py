...
@auth_router.post('/verify_account', status_code=status.HTTP_200_OK)
...
@auth_router.post('/resend_confirmation_code', status_code=status.HTTP_200_OK)
...
@auth_router.post('/confirm_forgot_password', status_code=status.HTTP_200_OK)
...
@auth_router.post('/new_token', status_code=status.HTTP_200_OK)
...
# GET USER DETAILS
@auth_router.get('/user_details', status_code=status.HTTP_200_OK)
